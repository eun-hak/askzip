...
export const carTaxAnnualPrepay: Article = {
  ...
  description:
    '자동차세를 1월에 연납하면 약 4.6%를 아낄 수 있습니다(2~12월분 세액의 5% 공제). 위택스·스마트위택스, 서울은 서울시 ETAX에서 신청하는 방법을 안내합니다.',
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: '1월 연납은 남은 2~12월분(11개월) 세액에 대해 5%를 공제하는 방식이라, 1년 전체 세액 기준으로는 약 4.6% 정도를 아끼게 됩니다. 신청 시기가 늦어질수록 공제 대상 기간이 줄어 할인 폭도 단계적으로 작아집니다.',
    },
    {
      type: 'table',
    ...
    {
      type: 'tip',
      text: '1월 연납 신청 기간은 보통 1월 16일부터 1월 31일까지입니다. 해마다 기간이 조금씩 다를 수 있으므로 위택스(또는 서울시 ETAX) 공지사항을 확인하세요.',
    },
    {
      type: 'h2',
      id: 'period',
      ...
      steps: [
        {
          step: 1,
          title: '위택스 홈페이지 접속',
          description: 'wetax.go.kr 에 접속해 공동인증서·간편인증으로 로그인합니다. (서울 차량은 서울시 ETAX 이용)',
        },
        {
          step: 2,
    ...
    {
      type: 'warning',
      text: '연납 할인은 매년 1월에 다시 신청해야 적용됩니다. 작년에 받았다고 올해 자동으로 연장되지 않으며, 신청을 놓치면 6월·12월 정기분으로 부과됩니다. 할인율·신청 기간은 매년 달라질 수 있으니 위택스나 서울시 ETAX 공지를 확인하세요.',
    },
    {
      type: 'h2',
      id: 'faq',
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            '네, 연납 납부 후 차량을 매도하거나 폐차하면 남은 기간에 해당하는 세액이 자동으로 환급됩니다. 별도 신청 없이 다음 달에 환급되는 것이 일반적이며, 필요 시 위택스나 지자체에서 환급 신청도 가능합니다.',
        },
        {
        ...
        },
        {
          ...
          answer:
            '네, 신용카드로 연납해도 동일하게 연납 할인이 적용됩니다. 다만 일부 카드사의 무이자 할부 혜택과 중복 적용 여부는 카드사에 확인이 필요합니다.',
        },
      ],
    },
  ],
