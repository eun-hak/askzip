...
export const healthInsuranceEligibilityCertificate: Article = {
  ...
  content: [
    ...
    {
      type: 'notice',
      text: '자격득실확인서는 건강보험의 가입·상실(입·퇴사) "이력"을 보여주는 서류입니다. 실제 낸 보험료는 납부확인서, 소득은 소득금액증명으로 따로 발급해야 하니, 제출처가 요구한 서류 이름을 정확히 확인하세요.',
    },
    {
      type: 'h2',
      id: 'prep',
    ...
    {
      type: 'warning',
      text: '퇴사 직후에는 자격득실확인서에 최근 회사의 상실일(퇴사일)이 아직 안 잡혀 있을 수 있습니다. 회사가 상실신고를 해야 반영되기 때문이니, 이직 경력 증명 등으로 급하게 필요하면 발급 전에 이전 회사에 상실신고가 처리됐는지 먼저 확인하세요.',
    },
    {
      type: 'h2',
      id: 'faq',
      ...
      items: [
        {
          ...
          answer:
            '상실일이 비어 있다면 회사가 아직 상실신고를 하지 않은 것입니다. 상실신고 기한은 퇴사한 날의 다음 날부터 14일 이내이고, 공단 처리에 3~7일이 더 걸리기도 합니다. 급하면 이전 회사에 상실신고를 요청하세요. 신고가 늦더라도 상실일은 실제 퇴사일로 소급해 기재됩니다.',
        },
        {
