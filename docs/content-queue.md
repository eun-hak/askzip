...
- [ ] digital-wallet-rejected | 전자문서지갑으로 냈는데 기관이 안 받아줄 때 — 전자증명서 거부 대처법 | resident-registration-copy, family-relation-certificate | 전자증명서 법적 효력 근거 / 거부 시 즉시 대안(PDF·무인발급기) / 지원 서류 vs 미지원 서류
